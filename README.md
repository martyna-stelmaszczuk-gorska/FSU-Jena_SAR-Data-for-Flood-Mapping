...
* The template might be issue to updates and fixes. If this is the case, these changes will not be rolled out to your repository automatically. You can check if a merge via GitHub is possible without interference, but otherwise the adaptations need to be made in your repository manually. *(To see if there is no interference, pull a branch off your repository. Then, delete the contents of the branch and replace them with the updated template. Create a pull request and check for inconsitencies, if there are none you can merge the branches.)*
